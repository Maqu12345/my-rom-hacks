...
{
    u16 monData;
    CreateMon(&gPlayerParty[0], SPECIES_TAILLOW, 7, USE_RANDOM_IVS, FALSE, 0, OT_ID_PLAYER_ID, 0);
    monData = TRUE;
...
static const u8 *const sScrollableMultichoiceOptions[][MAX_SCROLL_MULTI_LENGTH] =
{
    ...
    {
        COMPOUND_STRING("LEFTOVERS{CLEAR_TO 0x5E}24BP"),
        COMPOUND_STRING("QUICK CLAW{CLEAR_TO 0x5E}24BP"),
        COMPOUND_STRING("SAFETY GOGGLES{CLEAR_TO 0x5E}24BP"),
        COMPOUND_STRING("BRIGHT POWDER{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("KING'S ROCK{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("SCOPE LENS{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("EXPERT BELT{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("ROCKY HELMET{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("CHOICE BAND{CLEAR_TO 0x5E}48BP"),
        COMPOUND_STRING("CHOICE SPECS{CLEAR_TO 0x5E}48BP"),
        COMPOUND_STRING("CHOICE SCARF{CLEAR_TO 0x5E}48BP"),
        COMPOUND_STRING("HEAVY-DUTY BOOTS{CLEAR_TO 0x5E}48BP"),
        COMPOUND_STRING("LIFE ORB{CLEAR_TO 0x5E}48BP"),
        COMPOUND_STRING("CLEAR AMULET{CLEAR_TO 0x5E}48BP"),
        COMPOUND_STRING("COVERT CLOAK{CLEAR_TO 0x5E}48BP"),
        gText_Exit
    },
    ...
    {
        COMPOUND_STRING("Psych Up{CLEAR_TO 0x4E}16BP"),
        COMPOUND_STRING("Electroweb{CLEAR_TO 0x4E}16BP"),
        COMPOUND_STRING("Drill Run{CLEAR_TO 0x4E}16BP"),
        COMPOUND_STRING("Worry Seed{CLEAR_TO 0x4E}16BP"),
        COMPOUND_STRING("Upper Hand{CLEAR_TO 0x4E}16BP"),
        COMPOUND_STRING("Super Fang{CLEAR_TO 0x4E}16BP"),
        COMPOUND_STRING("Iron Defense{CLEAR_TO 0x4E}24BP"),
        COMPOUND_STRING("Amnesia{CLEAR_TO 0x4E}24BP"),
        COMPOUND_STRING("Trick Room{CLEAR_TO 0x4E}24BP"),
        COMPOUND_STRING("Tailwind{CLEAR_TO 0x4E}24BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_MOVE_TUTOR_2] =
    {
        COMPOUND_STRING("Heat Wave{CLEAR_TO 0x4E}16BP"),
        COMPOUND_STRING("Body Slam{CLEAR_TO 0x4E}16BP"),
        COMPOUND_STRING("Weather Ball{CLEAR_TO 0x4E}16BP"),
        COMPOUND_STRING("Terrain Pulse{CLEAR_TO 0x4E}16BP"),
        COMPOUND_STRING("Grassy Glide{CLEAR_TO 0x4E}24BP"),
        COMPOUND_STRING("Rising Voltage{CLEAR_TO 0x4E}24BP"),
        COMPOUND_STRING("Expanding Fo…{CLEAR_TO 0x4E}24BP"),
        COMPOUND_STRING("Ice Punch{CLEAR_TO 0x4E}24BP"),
        COMPOUND_STRING("Thunder Punch{CLEAR_TO 0x4E}24BP"),
        COMPOUND_STRING("Fire Punch{CLEAR_TO 0x4E}24BP"),
        gText_Exit
    },
