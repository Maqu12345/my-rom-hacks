...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_POINTEDSTONESFLOAT]                   = COMPOUND_STRING("Invisible hazards float in the air around {B_DEF_TEAM2} team!"),
    ...
    [STRINGID_STEALTHROCKDMG]                       = COMPOUND_STRING("Invisible hazards dug into {B_SCR_NAME_WITH_PREFIX2}!"),
    ...
    [STRINGID_PKMNBLEWAWAYSTEALTHROCK]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} blew away Stealth Trap!"),
    ...
    [STRINGID_STEALTHROCKDISAPPEAREDFROMTEAM]       = COMPOUND_STRING("The invisible hazards disappeared from around {B_ATK_TEAM2} team!"),
...
const u8 gText_BattleWallyName[] = _("STEVEN");
