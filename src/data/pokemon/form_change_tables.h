...
static const struct FormChange sCastformFormChangeTable[] = {
    ...
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_CASTFORM_RAINY,  WEATHER_SNOW},
    ...
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_CASTFORM_RAINY, B_WEATHER_HAIL | B_WEATHER_SNOW, ABILITY_FORECAST},
