...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_BUTTERFREE] =
    {
        ...
        .baseSpDefense = 80,
        .types = MON_TYPES(TYPE_BUG, TYPE_WIND),
        .catchRate = 45,
...
#define RAICHU_SPEED (P_UPDATED_STATS >= GEN_6 ? 110 : 100)
    ...
    [SPECIES_RAICHU_ALOLA] =
    {
        ...
        .baseSpAttack  = 95,
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_WARPED),
        .catchRate = 75,
        .expYield = RAICHU_EXP_YIELD,
        .evYield_Speed = 3,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_NIDOQUEEN] =
    {
        ...
        .types = MON_TYPES(TYPE_POISON, TYPE_EARTH),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 253,
    #elif P_UPDATED_EXP_YIELDS >= GEN_7
    ...
    #define CLEFAIRY_FAMILY_TYPES { TYPE_LIGHT, TYPE_LIGHT }
#else
    #define CLEFAIRY_FAMILY_TYPES { TYPE_VOID, TYPE_VOID }
#endif
...
#if P_UPDATED_TYPES >= GEN_6
    #define JIGGLYPUFF_FAMILY_TYPES { TYPE_SOUND, TYPE_VOID}
#else
    #define JIGGLYPUFF_FAMILY_TYPES { TYPE_VOID, TYPE_VOID}
#endif
...
#define WIGGLYTUFF_SP_ATK   50
    ...
    [SPECIES_PARAS] =
    {
        ...
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 45 : 55,
        .baseSpDefense = 55,
        .types = MON_TYPES(TYPE_BUG, TYPE_NATURE),
        .catchRate = 190,
    ...
    [SPECIES_ANNIHILAPE] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 90,
        .types = MON_TYPES(TYPE_FIGHTING, TYPE_NETHER),
        .catchRate = 45,
        .expYield = 268,
        .evYield_Attack = 3,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_ABRA] =
    {
        ...
        .types = MON_TYPES(TYPE_WARPED, TYPE_VOID),
        .catchRate = 200,
...
#define ALAKAZAM_SP_DEF 135
    ...
    [SPECIES_MACHOP] =
    {
        ...
        .baseSpAttack  = 35,
        .baseSpDefense = 35,
        .types = MON_TYPES(TYPE_FIGHTING, TYPE_VOID),
        .catchRate = 180,
    #if P_UPDATED_EXP_YIELDS >= GEN_5
        .expYield = 61,
    #elif P_UPDATED_EXP_YIELDS >= GEN_4
...
#define FARFETCHD_ATTACK (P_UPDATED_STATS >= GEN_7 ? 90 : 65)
    ...
    [SPECIES_GRIMER_ALOLA] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_POISON, TYPE_VOID),
        .catchRate = 190,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 65 : 90,
        .evYield_HP = 1,
        .itemRare = ITEM_BLACK_SLUDGE,
...
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE}
    ...
    [SPECIES_VOLTORB] =
    {
        ...
        .baseSpAttack  = 55,
        .baseSpDefense = 55,
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_ILLUSION),
        .catchRate = 190,
    ...
    [SPECIES_EXEGGCUTE] =
    {
        ...
        .types = MON_TYPES(TYPE_NATURE, TYPE_PSYCHIC),
        .catchRate = 90,
    ...
    [SPECIES_CUBONE] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = P_UPDATED_STATS >= GEN_2 ? 50 : 40,
        .types = MON_TYPES(TYPE_VOID, TYPE_NETHER),
        .catchRate = 190,
    ...
    [SPECIES_MAROWAK_ALOLA] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 80,
        .types = MON_TYPES(TYPE_FIRE, TYPE_NETHER),
        .catchRate = 75,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 149 : 124,
        .evYield_Defense = 2,
        .itemRare = ITEM_THICK_CLUB,
    ...
    [SPECIES_WEEZING_GALAR] =
    {
        ...
        .baseSpAttack  = 85,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_POISON, TYPE_LIGHT),
        .catchRate = 60,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 172 : 173,
        .evYield_Defense = 2,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_LEVITATE, ABILITY_NEUTRALIZING_GAS, ABILITY_AROMA_VEIL },
        .bodyColor = BODY_COLOR_GRAY,
        .noFlip = TRUE,
        .speciesName = _("Weezing"),
        .cryId = CRY_WEEZING,
    ...
    [SPECIES_RHYHORN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_ROCK_HEAD, ABILITY_RECKLESS },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_RHYPERIOR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_SOLID_ROCK, ABILITY_RECKLESS },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_SCYTHER] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_AERILATE, ABILITY_TECHNICIAN, ABILITY_STEADFAST },
    #else
    ...
    [SPECIES_SCIZOR] =
    {
        ...
        .baseSpAttack  = 55,
        .baseSpDefense = 80,
        .types = MON_TYPES(TYPE_STEEL, TYPE_WIND),
        .catchRate = 25,
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_AERILATE, ABILITY_TECHNICIAN, ABILITY_LIGHT_METAL },
    #else
    ...
    [SPECIES_KLEAVOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_HEATPROOF, ABILITY_SHEER_FORCE, ABILITY_SHARPNESS },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_PORYGON_Z] =
    {
        ...
        .baseSpAttack  = 135,
        .baseSpDefense = 75,
        .types = MON_TYPES(TYPE_STEEL, TYPE_WARPED),
        .catchRate = 30,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 268,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
