...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_SCEPTILE_MEGA] =
    {
        ...
        .baseSpAttack  = 145,
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_NATURE, TYPE_DRAGON),
        .catchRate = 45,
    ...
    [SPECIES_POOCHYENA] =
    {
        ...
        .baseSpAttack  = 30,
        .baseSpDefense = 30,
        .types = MON_TYPES(TYPE_DARK, TYPE_VOID),
        .catchRate = 255,
    ...
    [SPECIES_OBSTAGOON] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 81,
        .types = MON_TYPES(TYPE_DARK, TYPE_SOUND),
        .catchRate = 45,
        .expYield = 260,
        .evYield_Defense = 3,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_WURMPLE] =
    {
        ...
        .baseSpAttack  = 20,
        .baseSpDefense = 30,
        .types = MON_TYPES(TYPE_NATURE, TYPE_POISON),
        .catchRate = 255,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 56,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_DUSTOX] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 90,
        .types = MON_TYPES(TYPE_POISON, TYPE_WIND),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 193,
    #elif P_UPDATED_EXP_YIELDS >= GEN_7
    ...
    [SPECIES_TAILLOW] =
    {
        ...
        .baseSpAttack  = 30,
        .baseSpDefense = 30,
        .types = MON_TYPES(TYPE_VOID, TYPE_WIND),
        .catchRate = 200,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_SLAKING] =
    {
        ...
        .baseSpAttack  = 95,
        .baseSpDefense = 65,
        .types = MON_TYPES(TYPE_VOID, TYPE_FIGHTING),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 285,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_SHEDINJA] =
    {
        ...
        .baseSpAttack  = 30,
        .baseSpDefense = 30,
        .types = MON_TYPES(TYPE_NATURE, TYPE_NETHER),
        .catchRate = 45,
    ...
    [SPECIES_SABLEYE] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 65,
        .types = MON_TYPES(TYPE_DARK, TYPE_NETHER),
        .catchRate = 45,
    ...
    #define MAWILE_TYPES { TYPE_STEEL, TYPE_WARPED }
#else
    ...
    [SPECIES_MEDITITE] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 55,
        .types = MON_TYPES(TYPE_FIGHTING, TYPE_ILLUSION),
        .catchRate = 180,
    ...
    [SPECIES_VOLBEAT] =
    {
        ...
        .types = MON_TYPES(TYPE_NATURE, TYPE_LIGHT),
        .catchRate = 150,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 151,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
        ...
        .abilities = { ABILITY_ILLUMINATE, ABILITY_COSTAR, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_ILLUMISE] =
    {
        ...
        .baseSpAttack  = 73,
        .baseSpDefense = P_UPDATED_STATS >= GEN_7 ? 85 : 75,
        .types = MON_TYPES(TYPE_NATURE, TYPE_VOID),
        .catchRate = 150,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 151,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG, EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_COSTAR, ABILITY_TINTED_LENS, ABILITY_PRANKSTER },
    #else
    ...
    [SPECIES_SPINDA] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_SOUND, TYPE_WARPED),
        .catchRate = 255,
    ...
    [SPECIES_ALTARIA] =
    {
        ...
        .baseSpAttack  = 70,
        .baseSpDefense = 105,
        .types = MON_TYPES(TYPE_WIND, TYPE_SOUND),
        .catchRate = 45,
    ...
    [SPECIES_CRAWDAUNT] =
    {
        ...
        .baseSpAttack  = 90,
        .baseSpDefense = 55,
        .types = MON_TYPES(TYPE_WATER, TYPE_ILLUSION),
        .catchRate = 155,
    ...
    [SPECIES_BALTOY] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_EARTH, TYPE_WARPED),
        .catchRate = 255,
    ...
    [SPECIES_CHINGLING] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_ILLUSION, TYPE_SOUND),
        .catchRate = 120,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_ANTICIPATION, ABILITY_MOODY },
    #else
    ...
    [SPECIES_GLALIE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_MINERAL),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_ANGER_SHELL, ABILITY_MOODY },
    #else
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_NONE, ABILITY_MOODY },
    #endif
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_FROSLASS] =
    {
        ...
        .baseSpAttack  = 80,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_WIND, TYPE_NETHER),
        .catchRate = 75,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 168 : 187,
        .evYield_Speed = 2,
        .genderRatio = MON_FEMALE,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_THICK_FAT, ABILITY_BULLETPROOF, ABILITY_OBLIVIOUS },
    #else
    ...
    [SPECIES_BELDUM] =
    {
        ...
        .baseSpAttack  = 35,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_STEEL, TYPE_ILLUSION),
        .catchRate = 15,
    ...
    [SPECIES_REGIROCK] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_ROCKY_PAYLOAD, ABILITY_NONE, ABILITY_CLEAR_BODY },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    [SPECIES_REGISTEEL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_STEELWORKER, ABILITY_NONE, ABILITY_CLEAR_BODY },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_LATIAS] =
    {
        ...
        .baseSpAttack  = 110,
        .baseSpDefense = 130,
        .types = MON_TYPES(TYPE_ILLUSION, TYPE_WIND),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 300,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_LATIOS] =
    {
        ...
        .baseSpAttack  = 130,
        .baseSpDefense = 110,
        .types = MON_TYPES(TYPE_ILLUSION, TYPE_LIGHT),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 300,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_KYOGRE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_DRIZZLE, ABILITY_NONE, ABILITY_PRIMORDIAL_SEA },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_GROUDON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_DROUGHT, ABILITY_NONE, ABILITY_DESOLATE_LAND },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_RAYQUAZA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_AIR_LOCK, ABILITY_NONE, ABILITY_DELTA_STREAM },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_JIRACHI] =
    {
        ...
        .baseSpAttack  = 100,
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_LIGHT, TYPE_WARPED),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 300,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
