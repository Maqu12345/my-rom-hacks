...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_BIBAREL] =
    {
        ...
        .baseSpAttack  = 55,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_VOID, TYPE_WATER),
        .catchRate = 127,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_DRIFLOON] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 44,
        .types = MON_TYPES(TYPE_NETHER, TYPE_WIND),
        .catchRate = 125,
    ...
    [SPECIES_ROTOM] =
    {
        ...
        .baseSpAttack  = 95,
        .baseSpDefense = 77,
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_NETHER),
        .catchRate = 45,
    ...
    [SPECIES_GIRATINA_ALTERED] =
    {
        ...
        .baseSpAttack  = 100,
        .baseSpDefense = 120,
        .types = MON_TYPES(TYPE_NETHER, TYPE_DRAGON),
        .catchRate = 3,
    ...
    [SPECIES_CRESSELIA] =
    {
        ...
        .types = MON_TYPES(TYPE_DREAM, TYPE_LIGHT),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 300,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
...
#define ARCEUS_SPECIES_INFO(type, typeName, iconPal)                                \
    ...
    [SPECIES_ARCEUS_NORMAL]   = ARCEUS_SPECIES_INFO(TYPE_VOID,   Normal,   1),
    ...
    [SPECIES_ARCEUS_ROCK]     = ARCEUS_SPECIES_INFO(TYPE_EARTH,     Rock,     2),
    [SPECIES_ARCEUS_BUG]      = ARCEUS_SPECIES_INFO(TYPE_BUG,      Bug,      1),
    [SPECIES_ARCEUS_GHOST]    = ARCEUS_SPECIES_INFO(TYPE_NETHER,    Ghost,    2),
