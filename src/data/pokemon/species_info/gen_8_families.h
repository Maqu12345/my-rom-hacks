...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_RILLABOOM] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_NATURE, TYPE_SOUND),
        .catchRate = 45,
        .expYield = 265,
        .evYield_Attack = 3,
        .genderRatio = PERCENT_FEMALE(12.5),
    ...
    [SPECIES_HATENNA] =
    {
        ...
        .baseSpAttack  = 56,
        .baseSpDefense = 53,
        .types = MON_TYPES(TYPE_ILLUSION, TYPE_VOID),
        .catchRate = 235,
        .expYield = 53,
        .evYield_SpAttack = 1,
...
#define ALCREMIE_REGULAR_SPECIES_INFO(sweet, cream, color)                                      \
    ...
    [SPECIES_INDEEDEE_M] =
    {
        ...
        .baseSpAttack  = 105,
        .baseSpDefense = 95,
        .types = MON_TYPES(TYPE_WARPED, TYPE_SOUND),
        .catchRate = 30,
        .expYield = 166,
        .evYield_SpAttack = 2,
        .itemRare = ITEM_TUNING_FORK,
        .genderRatio = MON_MALE,
        .eggCycles = 40,
        .friendship = 140,
        .growthRate = GROWTH_FAST,
    ...
    [SPECIES_REGIDRAGO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_DRAGONS_MAW, ABILITY_NONE, ABILITY_CLEAR_BODY },
        .bodyColor = BODY_COLOR_GREEN,
