...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_ESPATHRA] =
    {
        ...
        .baseSpAttack  = 101,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_WARPED, TYPE_LIGHT),
        .catchRate = 60,
        .expYield = 168,
        .evYield_Speed = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_VAROOM] =
    {
        ...
        .frontPicYOffset = 14,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .frontAnimId = ANIM_V_SHAKE_H_SLIDE_SLOW,
    ...
    [SPECIES_CYCLIZAR] =
    {
        ...
        .baseSpAttack  = 85,
        .baseSpDefense = 65,
        .types = MON_TYPES(TYPE_VOID, TYPE_STEEL),
        .catchRate = 190,
        .expYield = 175,
        .evYield_Speed = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_GLIMMET] =
    {
        ...
        .baseSpAttack  = 105,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_EARTH, TYPE_POISON),
        .catchRate = 70,
        .expYield = 70,
        .evYield_SpAttack = 1,
    ...
    [SPECIES_FRIGIBAX] =
    {
        ...
        .abilities = { ABILITY_THERMAL_EXCHANGE, ABILITY_NONE, ABILITY_REFRIGERATE },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_MUNKIDORI] =
    {
        ...
        .baseSpAttack  = 130,
        .baseSpDefense = 90,
        .types = MON_TYPES(TYPE_POISON, TYPE_WARPED),
        .catchRate = 3,
        .expYield = 278,
        .evYield_SpAttack = 3,
        .genderRatio = MON_MALE,
...
#define OGERPON_SPECIES_INFO(Form1, Form2, type, ability, color, frontYOffset, backYOffset, iconpalette, isTeraform)    \
    {                                                                                                                   \
        ...
        .baseSpAttack  = 60,                                                                                            \
        .baseSpDefense = 96,                                                                                            \
        .types = MON_TYPES(TYPE_FIGHTING, type),                                                                        \
        .forceTeraType = type,                                                                                          \
        .catchRate = 5,                                                                                                 \
        .expYield = 275,                                                                                                \
        .evYield_Attack = 3,                                                                                            \
    ...
    [SPECIES_OGERPON_CORNERSTONE]      = OGERPON_SPECIES_INFO(Cornerstone, Cornerstone,     TYPE_EARTH, ABILITY_STURDY,                         BODY_COLOR_GRAY,  1, 6, 0, FALSE),
#if P_TERA_FORMS
    ...
    [SPECIES_PECHARUNT] =
    {
        ...
        .baseSpAttack  = 88,
        .baseSpDefense = 88,
        .types = MON_TYPES(TYPE_POISON, TYPE_NETHER),
        .catchRate = 3,
        .expYield = 300,
        .evYield_Defense = 3,
        .genderRatio = MON_GENDERLESS,
