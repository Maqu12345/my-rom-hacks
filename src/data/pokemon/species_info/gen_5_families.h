...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_AUDINO] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 86,
        .types = MON_TYPES(TYPE_VOID, TYPE_SOUND),
        .catchRate = 255,
        .expYield = 490,
        .evYield_HP = 2,
    ...
    [SPECIES_SIGILYPH] =
    {
        ...
        .baseSpAttack  = 103,
        .baseSpDefense = 80,
        .types = MON_TYPES(TYPE_WARPED, TYPE_WIND),
        .catchRate = 45,
        .expYield = 172,
        .evYield_SpAttack = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_JOLTIK] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_COMPOUND_EYES, ABILITY_UNNERVE, ABILITY_VOLT_ABSORB },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_LITWICK] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 55,
        .types = MON_TYPES(TYPE_NETHER, TYPE_FIRE),
        .catchRate = 190,
        .expYield = 55,
        .evYield_SpAttack = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_GOLETT] =
    {
        ...
        .baseSpAttack  = 35,
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_EARTH, TYPE_NETHER),
        .catchRate = 190,
        .expYield = 61,
        .evYield_Attack = 1,
    ...
    [SPECIES_LARVESTA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_FLAME_BODY, ABILITY_NONE, ABILITY_HEATPROOF },
        .bodyColor = BODY_COLOR_WHITE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 53, SPECIES_VOLCARONA}),
    },
    ...
    [SPECIES_KYUREM_WHITE] =
    {
        ...
        .baseSpAttack  = 170,
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_LIGHT, TYPE_WATER),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 350,
    #elif P_UPDATED_EXP_YIELDS >= GEN_7
