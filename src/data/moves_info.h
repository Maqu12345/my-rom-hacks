...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_SWEET_KISS] =
    {
        ...
        .effect = EFFECT_CONFUSE,
        .power = 0,
        .type = B_UPDATED_MOVE_TYPES >= GEN_6 ? TYPE_NETHER : TYPE_VOID,
        .accuracy = 75,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_CHARM] =
    {
        ...
        .power = 0,
        .type = B_UPDATED_MOVE_TYPES >= GEN_6 ? TYPE_VOID : TYPE_VOID,
        .accuracy = 100,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_MOONLIGHT] =
    {
        ...
        .power = 0,
        .type = B_UPDATED_MOVE_TYPES >= GEN_6 ? TYPE_LIGHT : TYPE_VOID,
        .accuracy = 0,
        .pp = 5,
        .target = MOVE_TARGET_USER,
        .priority = 0,
    ...
    [MOVE_STEALTH_ROCK] =
    {
        .name = COMPOUND_STRING("Stealth Trap"),
        .description = COMPOUND_STRING(
            "Sets floating hazards that\n"
    ...
    [MOVE_EERIE_IMPULSE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Exposes the foe to pulses\n"
            "that sharply cut Sp. Atk."),
