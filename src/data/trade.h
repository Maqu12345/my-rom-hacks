...
static const struct InGameTrade sIngameTrades[] =
{
    [INGAME_TRADE_SEEDOT] =
    {
        ...
        .otGender = MALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_BUDEW
    },
    [INGAME_TRADE_PLUSLE] =
    {
        .nickname = _("Naty"),
        .species = SPECIES_NATU,
        .ivs = {14, 14, 14, 26, 26, 14},
        .abilityNum = 2,
        .otId = 73996,
    ...
    [INGAME_TRADE_HORSEA] =
    {
        ...
        .otGender = MALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_CHINCHOU
    },
    [INGAME_TRADE_MEOWTH] =
    {
        .nickname = _("Sunny"),
        .species = SPECIES_VULPIX,
        .ivs = {16, 0, 16, 31, 31, 31},
        .abilityNum = 2,
        .otId = 91481,
        .conditions = {30, 5, 5, 5, 5},
        .personality = 0x8C,
        .heldItem = ITEM_PEARL_STRING,
        .mailNum = -1,
        .otName = _("ISIS"),
        .otGender = FEMALE,
        .sheen = 10,
