...
{
    SLATEPORT_TENT_MON_ROSELIA_1,
    SLATEPORT_TENT_MON_ROSELIA_2,
    SLATEPORT_TENT_MON_LOMBRE_1,
    SLATEPORT_TENT_MON_LOMBRE_2,
    SLATEPORT_TENT_MON_NUZLEAF_1,
    SLATEPORT_TENT_MON_NUZLEAF_2,
    SLATEPORT_TENT_MON_BEAUTIFLY_1,
    SLATEPORT_TENT_MON_BEAUTIFLY_2,
    SLATEPORT_TENT_MON_DUSTOX_1,
    SLATEPORT_TENT_MON_DUSTOX_2,
    SLATEPORT_TENT_MON_MAWILE_1,
    SLATEPORT_TENT_MON_MAWILE_2,
    -1
};

const u16 gSlateportBattleTentTrainerMons_Malachi[] =
{
    SLATEPORT_TENT_MON_NOSEPASS_1,
    SLATEPORT_TENT_MON_NOSEPASS_2,
    SLATEPORT_TENT_MON_SUDOWOODO_1,
    SLATEPORT_TENT_MON_SUDOWOODO_2,
    SLATEPORT_TENT_MON_MAWILE_1,
    SLATEPORT_TENT_MON_MAWILE_2,
    SLATEPORT_TENT_MON_SABLEYE_1,
    SLATEPORT_TENT_MON_SABLEYE_2,
    SLATEPORT_TENT_MON_GLIMMET_1,
    SLATEPORT_TENT_MON_GLIMMET_2,
...
{
    SLATEPORT_TENT_MON_LUVDISC_1,
    SLATEPORT_TENT_MON_LUVDISC_2,
    SLATEPORT_TENT_MON_STARYU_1,
    SLATEPORT_TENT_MON_STARYU_2,
    SLATEPORT_TENT_MON_TENTACOOL_1,
    SLATEPORT_TENT_MON_TENTACOOL_2,
    SLATEPORT_TENT_MON_LINOONE_1,
    SLATEPORT_TENT_MON_LINOONE_2,
    SLATEPORT_TENT_MON_NIDORINO_1,
    SLATEPORT_TENT_MON_NIDORINO_2,
    SLATEPORT_TENT_MON_MINUN_1,
    SLATEPORT_TENT_MON_MINUN_2,
    -1
};

const u16 gSlateportBattleTentTrainerMons_Davon[] =
{
    SLATEPORT_TENT_MON_PRINPLUP_1,
    SLATEPORT_TENT_MON_PRINPLUP_2,
    SLATEPORT_TENT_MON_LOMBRE_1,
    SLATEPORT_TENT_MON_LOMBRE_2,
    SLATEPORT_TENT_MON_TENTACOOL_1,
    SLATEPORT_TENT_MON_TENTACOOL_2,
    SLATEPORT_TENT_MON_LOUDRED_1,
    SLATEPORT_TENT_MON_LOUDRED_2,
    SLATEPORT_TENT_MON_NIDORINO_1,
    SLATEPORT_TENT_MON_NIDORINO_2,
    SLATEPORT_TENT_MON_MINUN_1,
    SLATEPORT_TENT_MON_MINUN_2,
...
const u16 gSlateportBattleTentTrainerMons_Glenda[] =
{
    ...
    SLATEPORT_TENT_MON_LITLEO_1,
    SLATEPORT_TENT_MON_LITLEO_2,
    SLATEPORT_TENT_MON_LUXIO_1,
    SLATEPORT_TENT_MON_LUXIO_2,
    SLATEPORT_TENT_MON_ROSELIA_1,
    SLATEPORT_TENT_MON_ROSELIA_2,
    SLATEPORT_TENT_MON_HATTREM_1,
    SLATEPORT_TENT_MON_HATTREM_2,
    -1
};
...
const u16 gSlateportBattleTentTrainerMons_Helena[] =
{
    SLATEPORT_TENT_MON_BEAUTIFLY_1,
    SLATEPORT_TENT_MON_BEAUTIFLY_2,
    SLATEPORT_TENT_MON_COMBUSKEN_1,
    SLATEPORT_TENT_MON_COMBUSKEN_2,
    SLATEPORT_TENT_MON_PRINPLUP_1,
    SLATEPORT_TENT_MON_PRINPLUP_2,
    SLATEPORT_TENT_MON_GLIMMET_1,
    SLATEPORT_TENT_MON_GLIMMET_2,
    SLATEPORT_TENT_MON_SPINDA_1,
    SLATEPORT_TENT_MON_SPINDA_2,
    SLATEPORT_TENT_MON_HATTREM_1,
    SLATEPORT_TENT_MON_HATTREM_2,
    -1
};
...
const u16 gSlateportBattleTentTrainerMons_Rodolfo[] =
{
    SLATEPORT_TENT_MON_LINOONE_1,
    SLATEPORT_TENT_MON_LINOONE_2,
    SLATEPORT_TENT_MON_THWACKEY_1,
    SLATEPORT_TENT_MON_THWACKEY_2,
    SLATEPORT_TENT_MON_PRINPLUP_1,
    SLATEPORT_TENT_MON_PRINPLUP_2,
    SLATEPORT_TENT_MON_LITLEO_1,
    SLATEPORT_TENT_MON_LITLEO_2,
    SLATEPORT_TENT_MON_HOUNDOUR_1,
    SLATEPORT_TENT_MON_HOUNDOUR_2,
    SLATEPORT_TENT_MON_LUXIO_1,
    SLATEPORT_TENT_MON_LUXIO_2,
    -1
};
...
const u16 gSlateportBattleTentTrainerMons_Davion[] =
{
    ...
    SLATEPORT_TENT_MON_THWACKEY_1,
    SLATEPORT_TENT_MON_THWACKEY_2,
    SLATEPORT_TENT_MON_VOLTORB_1,
    SLATEPORT_TENT_MON_VOLTORB_2,
    SLATEPORT_TENT_MON_SPINDA_1,
    SLATEPORT_TENT_MON_SPINDA_2,
    -1
};
...
const u16 gSlateportBattleTentTrainerMons_Kendall[] =
{
    ...
    SLATEPORT_TENT_MON_PRINPLUP_1,
    SLATEPORT_TENT_MON_PRINPLUP_2,
    SLATEPORT_TENT_MON_MACHOKE_1,
    SLATEPORT_TENT_MON_MACHOKE_2,
    SLATEPORT_TENT_MON_LUVDISC_1,
    SLATEPORT_TENT_MON_LUVDISC_2,
    -1
};
...
{
    SLATEPORT_TENT_MON_KADABRA_1,
    SLATEPORT_TENT_MON_KADABRA_2,
    SLATEPORT_TENT_MON_MACHOKE_1,
    SLATEPORT_TENT_MON_MACHOKE_2,
    SLATEPORT_TENT_MON_HATTREM_1,
    SLATEPORT_TENT_MON_HATTREM_2,
    SLATEPORT_TENT_MON_MORGREM_1,
    SLATEPORT_TENT_MON_MORGREM_2,
    SLATEPORT_TENT_MON_LINOONE_1,
    SLATEPORT_TENT_MON_LINOONE_2,
    SLATEPORT_TENT_MON_MIGHTYENA_1,
    SLATEPORT_TENT_MON_MIGHTYENA_2,
...
const u16 gSlateportBattleTentTrainerMons_Irvin[] =
{
    ...
    SLATEPORT_TENT_MON_SUDOWOODO_1,
    SLATEPORT_TENT_MON_SUDOWOODO_2,
    SLATEPORT_TENT_MON_KOFFING_1,
    SLATEPORT_TENT_MON_KOFFING_2,
    SLATEPORT_TENT_MON_LINOONE_1,
    SLATEPORT_TENT_MON_LINOONE_2,
    SLATEPORT_TENT_MON_LOUDRED_1,
    SLATEPORT_TENT_MON_LOUDRED_2,
...
const u16 gSlateportBattleTentTrainerMons_Maggie[] =
{
    ...
    SLATEPORT_TENT_MON_MORGREM_1,
    SLATEPORT_TENT_MON_MORGREM_2,
    SLATEPORT_TENT_MON_GRAVELER_1,
    SLATEPORT_TENT_MON_GRAVELER_2,
    SLATEPORT_TENT_MON_COMBUSKEN_1,
    SLATEPORT_TENT_MON_COMBUSKEN_2,
    -1
};
...
{
    SLATEPORT_TENT_MON_METANG_1,
    SLATEPORT_TENT_MON_METANG_2,
    SLATEPORT_TENT_MON_GRAVELER_1,
    SLATEPORT_TENT_MON_GRAVELER_2,
    SLATEPORT_TENT_MON_MACHOKE_1,
    SLATEPORT_TENT_MON_MACHOKE_2,
...
const u16 gSlateportBattleTentTrainerMons_Reggie[] =
{
    ...
    SLATEPORT_TENT_MON_NIDORINO_1,
    SLATEPORT_TENT_MON_NIDORINO_2,
    SLATEPORT_TENT_MON_PORYGON_1,
    SLATEPORT_TENT_MON_PORYGON_2,
    -1
};
...
const struct BattleFrontierTrainer gSlateportBattleTentTrainers[NUM_BATTLE_TENT_TRAINERS] =
{
    ...
    [SLATEPORT_TENT_TRAINER_MAGGIE] = {
        ...
        .speechBefore = {EC_POKEMON(VULPIX), EC_POKEMON(XATU), EC_POKEMON(LUNATONE), EC_WORD_ELLIPSIS, EC_WORD_UM, EC_WORD_ELLIPSIS},
        .speechWin = {EC_POKEMON(NOSEPASS), EC_WORD_ELLIPSIS, EC_WORD_UM, EC_POKEMON(SEVIPER), EC_WORD_EXCL, -1},
        .speechLose = {EC_POKEMON(NOSEPASS), EC_WORD_ELLIPSIS, EC_WORD_UM, EC_POKEMON(SLAKING), EC_WORD_ELLIPSIS, EC_WORD_UH_OH},
...
const struct TrainerMon gSlateportBattleTentMons[NUM_SLATEPORT_TENT_MONS] =
{
    [SLATEPORT_TENT_MON_THWACKEY_1] = {
        ...
        .moves = {MOVE_DOUBLE_HIT, MOVE_SCREECH, MOVE_SEED_BOMB, MOVE_THIEF},
        .heldItem = ITEM_NONE,
    ...
    [SLATEPORT_TENT_MON_THWACKEY_2] = {
        .species = SPECIES_THWACKEY,
        .moves = {MOVE_LEECH_SEED, MOVE_DANCING_RAIN, MOVE_GRASSY_TERRAIN, MOVE_GRASSY_GLIDE},
    ...
    [SLATEPORT_TENT_MON_COMBUSKEN_1] = {
        ...
        .moves = {MOVE_DOUBLE_KICK, MOVE_FIRE_PUNCH, MOVE_THUNDER_PUNCH, MOVE_FOCUS_ENERGY},
    ...
    [SLATEPORT_TENT_MON_COMBUSKEN_2] = {
        .species = SPECIES_COMBUSKEN,
        .moves = {MOVE_FLAMETHROWER, MOVE_FOCUS_BLAST, MOVE_AERIAL_ACE, MOVE_REVERSAL},
    ...
    [SLATEPORT_TENT_MON_PRINPLUP_1] = {
        ...
        .moves = {MOVE_CHILLING_WATER, MOVE_SWAGGER, MOVE_MIST, MOVE_DRILL_PECK},
    ...
    [SLATEPORT_TENT_MON_PRINPLUP_2] = {
        .species = SPECIES_PRINPLUP,
        .moves = {MOVE_BRINE, MOVE_BLIZZARD, MOVE_WHIRLPOOL, MOVE_FURY_ATTACK},
    ...
    [SLATEPORT_TENT_MON_LINOONE_1] = {
        ...
        .moves = {MOVE_HEADBUTT, MOVE_SWITCHEROO, MOVE_PIN_MISSILE, MOVE_DIG},
    ...
    [SLATEPORT_TENT_MON_LINOONE_2] = {
        .species = SPECIES_LINOONE,
        .moves = {MOVE_SLASH, MOVE_SHADOW_CLAW, MOVE_SIMPLE_BEAM, MOVE_PURSUIT},
    ...
    [SLATEPORT_TENT_MON_BEAUTIFLY_1] = {
        ...
        .moves = {MOVE_GUST, MOVE_BUG_BITE, MOVE_QUIVER_DANCE, MOVE_LEECH_LIFE},
        .heldItem = ITEM_BABIRI_BERRY,
        .ev = TRAINER_PARTY_EVS(16, 16, 16, 252, 252, 16),
        .nature = NATURE_HASTY
    },
    [SLATEPORT_TENT_MON_BEAUTIFLY_2] = {
        .species = SPECIES_BEAUTIFLY,
        .moves = {MOVE_GIGA_DRAIN, MOVE_AIR_CUTTER, MOVE_STUN_SPORE, MOVE_ATTRACT},
        .heldItem = ITEM_LUM_BERRY,
        .ev = TRAINER_PARTY_EVS(252, 16, 16, 16, 252, 16),
        .nature = NATURE_MODEST
    },
    [SLATEPORT_TENT_MON_DUSTOX_1] = {
        .species = SPECIES_DUSTOX,
        .moves = {MOVE_SLUDGE_BOMB, MOVE_BUG_BUZZ, MOVE_EXTRASENSORY, MOVE_PSYCHIC},
        .heldItem = ITEM_CHOICE_SPECS,
        .ev = TRAINER_PARTY_EVS(252, 32, 32, 32, 252, 32),
        .nature = NATURE_MODEST
    },
    [SLATEPORT_TENT_MON_DUSTOX_2] = {
        .species = SPECIES_DUSTOX,
        .moves = {MOVE_ICY_WIND, MOVE_TOXIC, MOVE_LIGHT_SCREEN, MOVE_MOONLIGHT},
        .heldItem = ITEM_SITRUS_BERRY,
        .ev = TRAINER_PARTY_EVS(170, 32, 32, 32, 170, 170),
        .nature = NATURE_CALM
    },
    [SLATEPORT_TENT_MON_LITLEO_1] = {
        .species = SPECIES_LITLEO,
        .moves = {MOVE_FIRE_FANG, MOVE_QUICK_ATTACK, MOVE_DIG, MOVE_WORK_UP},
        .heldItem = ITEM_MUSCLE_BAND,
        .ev = TRAINER_PARTY_EVS(64, 252, 64, 252, 64, 64),
        .nature = NATURE_JOLLY
    },
    [SLATEPORT_TENT_MON_LITLEO_2] = {
        .species = SPECIES_LITLEO,
        .moves = {MOVE_NOBLE_ROAR, MOVE_INCINERATE, MOVE_WILL_O_WISP, MOVE_SUNNY_DAY},
        .heldItem = ITEM_HEAT_ROCK,
        .ev = TRAINER_PARTY_EVS(252, 64, 64, 64, 252, 64),
        .nature = NATURE_MODEST
    },
    [SLATEPORT_TENT_MON_NIDORINO_1] = {
        .species = SPECIES_NIDORINO,
        .moves = {MOVE_TWINEEDLE, MOVE_DOUBLE_KICK, MOVE_FOCUS_ENERGY, MOVE_TRAILBLAZE},
    ...
    [SLATEPORT_TENT_MON_NIDORINO_2] = {
        .species = SPECIES_NIDORINO,
        .moves = {MOVE_POISON_JAB, MOVE_TOXIC_SPIKES, MOVE_DRILL_RUN, MOVE_SPIKES},
        .heldItem = ITEM_POISON_BARB,
        .ev = TRAINER_PARTY_EVS(64, 252, 252, 64, 64, 64),
        .nature = NATURE_IMPISH
    },
    [SLATEPORT_TENT_MON_LOMBRE_1] = {
        .species = SPECIES_LOMBRE,
        .moves = {MOVE_LEECH_SEED, MOVE_FAKE_OUT, MOVE_BUBBLE_BEAM, MOVE_ICY_WIND},
        .heldItem = ITEM_KEBIA_BERRY,
        .ev = TRAINER_PARTY_EVS(252, 96, 252, 96, 96, 96),
        .nature = NATURE_BOLD
    },
    [SLATEPORT_TENT_MON_LOMBRE_2] = {
        .species = SPECIES_LOMBRE,
        .moves = {MOVE_HYDRO_PUMP, MOVE_MEGA_DRAIN, MOVE_SWEET_SCENT, MOVE_RAIN_DANCE},
        .heldItem = ITEM_MIRACLE_SEED,
        .ev = TRAINER_PARTY_EVS(96, 96, 96, 96, 252, 252),
        .nature = NATURE_HARDY
    },
    [SLATEPORT_TENT_MON_NUZLEAF_1] = {
        .species = SPECIES_NUZLEAF,
        .moves = {MOVE_RAZOR_LEAF, MOVE_AIR_CUTTER, MOVE_FAKE_OUT, MOVE_GROWTH},
        .heldItem = ITEM_SCOPE_LENS,
        .ev = TRAINER_PARTY_EVS(96, 252, 96, 252, 96, 96),
        .nature = NATURE_NAIVE
    },
    [SLATEPORT_TENT_MON_NUZLEAF_2] = {
        .species = SPECIES_NUZLEAF,
        .moves = {MOVE_U_TURN, MOVE_BRICK_BREAK, MOVE_SOLAR_BLADE, MOVE_SUNNY_DAY},
        .heldItem = ITEM_BABIRI_BERRY,
        .ev = TRAINER_PARTY_EVS(170, 170, 96, 170, 96, 96),
        .nature = NATURE_ADAMANT
    },
    [SLATEPORT_TENT_MON_MORGREM_1] = {
        .species = SPECIES_MORGREM,
        .moves = {MOVE_DARK_PULSE, MOVE_DAZZLING_GLEAM, MOVE_NASTY_PLOT, MOVE_REST},
        .heldItem = ITEM_CHESTO_BERRY,
        .ev = TRAINER_PARTY_EVS(252, 48, 48, 48, 252, 48),
        .nature = NATURE_QUIRKY
    },
    [SLATEPORT_TENT_MON_MORGREM_2] = {
        .species = SPECIES_MORGREM,
        .moves = {MOVE_FALSE_SURRENDER, MOVE_FAKE_OUT, MOVE_ASSURANCE, MOVE_TAUNT},
        .heldItem = ITEM_ROCKY_HELMET,
        .ev = TRAINER_PARTY_EVS(170, 170, 170, 48, 48, 48),
        .nature = NATURE_BRAVE
    },
    [SLATEPORT_TENT_MON_HATTREM_1] = {
        .species = SPECIES_HATTREM,
        .moves = {MOVE_EERIE_SPELL, MOVE_MYSTICAL_FIRE, MOVE_BITTER_MALICE, MOVE_THUNDER_WAVE},
        .heldItem = ITEM_MAGO_BERRY,
        .ev = TRAINER_PARTY_EVS(170, 48, 170, 48, 48, 170),
        .nature = NATURE_MODEST
    },
    [SLATEPORT_TENT_MON_HATTREM_2] = {
        .species = SPECIES_HATTREM,
        .moves = {MOVE_DESTRUCTION, MOVE_EXTRASENSORY, MOVE_TRICK_ROOM, MOVE_GIGA_DRAIN},
    ...
    [SLATEPORT_TENT_MON_MIGHTYENA_1] = {
        ...
        .moves = {MOVE_BODY_SLAM, MOVE_OUTRAGE, MOVE_ROAR, MOVE_FIRE_FANG},
        .heldItem = ITEM_LUM_BERRY,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0),
        .nature = NATURE_JOLLY
    },
    [SLATEPORT_TENT_MON_MIGHTYENA_2] = {
        .species = SPECIES_MIGHTYENA,
        .moves = {MOVE_POWER_TRIP, MOVE_CRUNCH, MOVE_TRAILBLAZE, MOVE_HOWL},
    ...
    [SLATEPORT_TENT_MON_ROSELIA_1] = {
        ...
        .moves = {MOVE_LEECH_SEED, MOVE_TOXIC, MOVE_MAGICAL_LEAF, MOVE_VENOSHOCK},
        .heldItem = ITEM_SITRUS_BERRY,
    ...
    [SLATEPORT_TENT_MON_ROSELIA_2] = {
        .species = SPECIES_ROSELIA,
        .moves = {MOVE_AROMATHERAPY, MOVE_STUN_SPORE, MOVE_SPIKES, MOVE_GIGA_DRAIN},
    ...
    [SLATEPORT_TENT_MON_SUDOWOODO_1] = {
        ...
        .moves = {MOVE_ROCK_TOMB, MOVE_TEARFUL_LOOK, MOVE_FEINT_ATTACK, MOVE_TORMENT},
        .heldItem = ITEM_CRYSTAL_BALL,
        .ev = TRAINER_PARTY_EVS(0, 252, 252, 0, 0, 0),
        .nature = NATURE_RELAXED
    },
    [SLATEPORT_TENT_MON_SUDOWOODO_2] = {
        .species = SPECIES_SUDOWOODO,
        .moves = {MOVE_WOOD_HAMMER, MOVE_SUCKER_PUNCH, MOVE_COUNTER, MOVE_ROCK_SLIDE},
    ...
    [SLATEPORT_TENT_MON_LUVDISC_1] = {
        ...
        .moves = {MOVE_PSYCHIC_NOISE, MOVE_CHARM, MOVE_ICE_BEAM, MOVE_RAIN_DANCE},
        .heldItem = ITEM_DAMP_ROCK,
        .ev = TRAINER_PARTY_EVS(112, 112, 112, 252, 112, 252),
        .nature = NATURE_TIMID
    },
    [SLATEPORT_TENT_MON_LUVDISC_2] = {
        .species = SPECIES_LUVDISC,
        .moves = {MOVE_DANCING_RAIN, MOVE_SOAK, MOVE_ICY_WIND, MOVE_FLAIL},
        .heldItem = ITEM_FOCUS_SASH,
        .ev = TRAINER_PARTY_EVS(112, 252, 112, 252, 112, 112),
        .nature = NATURE_LONELY
    },
    [SLATEPORT_TENT_MON_LUXIO_1] = {
        .species = SPECIES_LUXIO,
        .moves = {MOVE_THUNDER_FANG, MOVE_FIRE_FANG, MOVE_ICE_FANG, MOVE_HOWL},
        .heldItem = ITEM_LIFE_ORB,
        .ev = TRAINER_PARTY_EVS(252, 252, 64, 64, 64, 64),
        .nature = NATURE_ADAMANT
    },
    [SLATEPORT_TENT_MON_LUXIO_2] = {
        .species = SPECIES_LUXIO,
        .moves = {MOVE_LIGHTNING_CUT, MOVE_LIGHT_UP, MOVE_CHARGE, MOVE_VOLT_SWITCH},
    ...
    [SLATEPORT_TENT_MON_LOUDRED_1] = {
        ...
        .moves = {MOVE_ECHOED_VOICE, MOVE_SHOCK_WAVE, MOVE_EXTRASENSORY, MOVE_METAL_SOUND},
    ...
    [SLATEPORT_TENT_MON_LOUDRED_2] = {
        .species = SPECIES_LOUDRED,
        .moves = {MOVE_DETONATION_BURST, MOVE_BODY_SLAM, MOVE_CIRCLE_THROW, MOVE_SCREECH},
    ...
    [SLATEPORT_TENT_MON_STARYU_1] = {
        ...
        .moves = {MOVE_SWIFT, MOVE_THUNDER_WAVE, MOVE_REFLECT, MOVE_LIGHT_SCREEN},
        .heldItem = ITEM_LIGHT_CLAY,
        .ev = TRAINER_PARTY_EVS(252, 96, 96, 252, 96, 96),
        .nature = NATURE_TIMID
    },
    [SLATEPORT_TENT_MON_STARYU_2] = {
        .species = SPECIES_STARYU,
        .moves = {MOVE_SIGNAL_BEAM, MOVE_CONFUSE_RAY, MOVE_RAPID_SPIN, MOVE_WATER_GUN},
        .heldItem = ITEM_MOONDUST,
        .ev = TRAINER_PARTY_EVS(96, 96, 96, 252, 252, 96),
        .nature = NATURE_RASH
    },
    [SLATEPORT_TENT_MON_TENTACOOL_1] = {
        .species = SPECIES_TENTACOOL,
        .moves = {MOVE_TOXIC, MOVE_VENOSHOCK, MOVE_HEX, MOVE_WATER_PULSE},
        .heldItem = ITEM_AIR_BALLOON,
        .ev = TRAINER_PARTY_EVS(112, 112, 112, 252, 252, 112),
        .nature = NATURE_TIMID
    },
    [SLATEPORT_TENT_MON_TENTACOOL_2] = {
        .species = SPECIES_TENTACOOL,
        .moves = {MOVE_POISON_JAB, MOVE_RAPID_SPIN, MOVE_KNOCK_OFF, MOVE_TOXIC_SPIKES},
        .heldItem = ITEM_CHOICE_SCARF,
        .ev = TRAINER_PARTY_EVS(170, 170, 112, 170, 112, 112),
        .nature = NATURE_JOLLY
    },
    [SLATEPORT_TENT_MON_GRAVELER_1] = {
        .species = SPECIES_GRAVELER,
        .moves = {MOVE_STEAMROLLER, MOVE_IRON_HEAD, MOVE_SANDSTORM, MOVE_ROCK_POLISH},
        .heldItem = ITEM_HARD_STONE,
        .ev = TRAINER_PARTY_EVS(16, 252, 252, 16, 16, 16),
        .nature = NATURE_LAX
    },
    [SLATEPORT_TENT_MON_GRAVELER_2] = {
        .species = SPECIES_GRAVELER,
        .moves = {MOVE_STONE_EDGE, MOVE_RAPID_SPIN, MOVE_SELF_DESTRUCT, MOVE_STEALTH_ROCK},
        .heldItem = ITEM_HEAVY_DUTY_BOOTS,
        .ev = TRAINER_PARTY_EVS(252, 252, 16, 16, 16, 16),
        .nature = NATURE_ADAMANT
    },
    [SLATEPORT_TENT_MON_NOSEPASS_1] = {
        .species = SPECIES_NOSEPASS,
        .moves = {MOVE_BODY_PRESS, MOVE_HARDEN, MOVE_POWER_GEM, MOVE_SHOCK_WAVE},
        .heldItem = ITEM_RINDO_BERRY,
        .ev = TRAINER_PARTY_EVS(170, 48, 170, 48, 170, 48),
        .nature = NATURE_BOLD
    },
    [SLATEPORT_TENT_MON_NOSEPASS_2] = {
        .species = SPECIES_NOSEPASS,
        .moves = {MOVE_EARTHQUAKE, MOVE_GRAVITY, MOVE_THUNDER_WAVE, MOVE_SANDSTORM},
        .heldItem = ITEM_SMOOTH_ROCK,
        .ev = TRAINER_PARTY_EVS(252, 48, 48, 48, 48, 252),
        .nature = NATURE_SASSY
    },
    [SLATEPORT_TENT_MON_KADABRA_1] = {
        .species = SPECIES_KADABRA,
        .moves = {MOVE_DESTRUCTION, MOVE_PSYBEAM, MOVE_REFLECT, MOVE_TELEPORT},
    ...
    [SLATEPORT_TENT_MON_KADABRA_2] = {
        .species = SPECIES_KADABRA,
        .moves = {MOVE_TERRAIN_PULSE, MOVE_PSYCHIC_TERRAIN, MOVE_LIGHT_SCREEN, MOVE_PSYCHIC_NOISE},
    ...
    [SLATEPORT_TENT_MON_ARON_1] = {
        ...
        .moves = {MOVE_BREAKING_SWIPE, MOVE_ROCK_TOMB, MOVE_DOUBLE_EDGE, MOVE_STEALTH_ROCK},
        .heldItem = ITEM_FIGY_BERRY,
        .ev = TRAINER_PARTY_EVS(112, 252, 252, 112, 112, 112),
        .nature = NATURE_IMPISH
    },
    [SLATEPORT_TENT_MON_ARON_2] = {
        .species = SPECIES_ARON,
        .moves = {MOVE_FURY_CUTTER, MOVE_SHADOW_CLAW, MOVE_DRAGON_TAIL, MOVE_PROTECT},
        .heldItem = ITEM_METRONOME,
        .ev = TRAINER_PARTY_EVS(252, 252, 112, 112, 112, 112),
        .nature = NATURE_ADAMANT
    },
    [SLATEPORT_TENT_MON_SABLEYE_1] = {
        .species = SPECIES_SABLEYE,
        .moves = {MOVE_FAKE_OUT, MOVE_NIGHT_SHADE, MOVE_CONFUSE_RAY, MOVE_TELEPORT},
        .heldItem = ITEM_LEFTOVERS,
        .ev = TRAINER_PARTY_EVS(252, 32, 252, 32, 32, 32),
        .nature = NATURE_IMPISH
    },
    [SLATEPORT_TENT_MON_SABLEYE_2] = {
        .species = SPECIES_SABLEYE,
        .moves = {MOVE_PAYBACK, MOVE_SPIRIT_BREAK, MOVE_RECOVER, MOVE_SUBSTITUTE},
        .heldItem = ITEM_MENTAL_HERB,
        .ev = TRAINER_PARTY_EVS(252, 252, 32, 32, 32, 32),
        .nature = NATURE_BRAVE
    },
    [SLATEPORT_TENT_MON_MAWILE_1] = {
        .species = SPECIES_MAWILE,
        .moves = {MOVE_PSYCHIC_FANGS, MOVE_ICE_FANG, MOVE_FIRE_FANG, MOVE_THUNDER_FANG},
        .heldItem = ITEM_CHOICE_BAND,
        .ev = TRAINER_PARTY_EVS(32, 252, 252, 32, 32, 32),
        .nature = NATURE_ADAMANT
    },
    [SLATEPORT_TENT_MON_MAWILE_2] = {
        .species = SPECIES_MAWILE,
        .moves = {MOVE_IRON_HEAD, MOVE_SUCKER_PUNCH, MOVE_LUNGE, MOVE_TORMENT},
        .heldItem = ITEM_QUICK_CLAW,
        .ev = TRAINER_PARTY_EVS(170, 170, 32, 170, 32, 32),
        .nature = NATURE_ADAMANT
    },
    [SLATEPORT_TENT_MON_METANG_1] = {
        .species = SPECIES_METANG,
        .moves = {MOVE_IRON_HEAD, MOVE_PURSUIT, MOVE_BRICK_BREAK, MOVE_AGILITY},
    ...
    [SLATEPORT_TENT_MON_METANG_2] = {
        .species = SPECIES_METANG,
        .moves = {MOVE_ZEN_HEADBUTT, MOVE_BULLET_PUNCH, MOVE_BODY_SLAM, MOVE_IRON_DEFENSE},
    ...
    [SLATEPORT_TENT_MON_PORYGON_1] = {
        ...
        .moves = {MOVE_REFLECT, MOVE_EERIE_IMPULSE, MOVE_DISCHARGE, MOVE_CONVERSION},
        .heldItem = ITEM_SITRUS_BERRY,
        .ev = TRAINER_PARTY_EVS(170, 16, 170, 16, 16, 170),
        .nature = NATURE_SERIOUS
    },
    [SLATEPORT_TENT_MON_PORYGON_2] = {
        .species = SPECIES_PORYGON,
        .moves = {MOVE_SILVER_WIND, MOVE_TRI_ATTACK, MOVE_TRICK_ROOM, MOVE_CONVERSION_2},
    ...
    [SLATEPORT_TENT_MON_MINUN_1] = {
        ...
        .moves = {MOVE_ELECTRO_BALL, MOVE_SUPER_FANG, MOVE_NUZZLE, MOVE_ENCORE},
    ...
    [SLATEPORT_TENT_MON_MINUN_2] = {
        .species = SPECIES_MINUN,
        .moves = {MOVE_ROUND, MOVE_SHOCK_WAVE, MOVE_NASTY_PLOT, MOVE_SWIFT},
        .heldItem = ITEM_TUNING_FORK,
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 0),
        .nature = NATURE_MILD
    },
    [SLATEPORT_TENT_MON_VOLTORB_1] = {
        .species = SPECIES_VOLTORB,
        .moves = {MOVE_SPARK, MOVE_FOUL_PLAY, MOVE_EXPLOSION, MOVE_STEALTH_ROCK},
    ...
    [SLATEPORT_TENT_MON_VOLTORB_2] = {
        .species = SPECIES_VOLTORB,
        .moves = {MOVE_RISING_VOLTAGE, MOVE_UNKNOWN_FLARE, MOVE_METAL_SOUND, MOVE_ELECTRIC_TERRAIN},
    ...
    [SLATEPORT_TENT_MON_GLIMMET_1] = {
        ...
        .moves = {MOVE_VENOSHOCK, MOVE_ANCIENT_POWER, MOVE_TOXIC, MOVE_SPIKES},
        .heldItem = ITEM_COBA_BERRY,
        .ev = TRAINER_PARTY_EVS(80, 80, 80, 252, 80, 252),
        .nature = NATURE_CALM
    },
    [SLATEPORT_TENT_MON_GLIMMET_2] = {
        .species = SPECIES_GLIMMET,
        .moves = {MOVE_METEOR_BEAM, MOVE_POWER_GEM, MOVE_ACID_SPRAY, MOVE_ROCK_POLISH},
        .heldItem = ITEM_POWER_HERB,
        .ev = TRAINER_PARTY_EVS(252, 80, 80, 80, 252, 80),
        .nature = NATURE_MODEST
    },
    [SLATEPORT_TENT_MON_MACHOKE_1] = {
        .species = SPECIES_MACHOKE,
        .moves = {MOVE_MEGA_KICK, MOVE_DUAL_CHOP, MOVE_REVENGE, MOVE_BULK_UP},
    ...
    [SLATEPORT_TENT_MON_MACHOKE_2] = {
        .species = SPECIES_MACHOKE,
        .moves = {MOVE_FACADE, MOVE_LOW_KICK, MOVE_SCARY_FACE, MOVE_KNOCK_OFF},
    ...
    [SLATEPORT_TENT_MON_HOUNDOUR_1] = {
        ...
        .moves = {MOVE_DARK_PULSE, MOVE_INCINERATE, MOVE_DESTINY_BOND, MOVE_TAUNT},
        .heldItem = ITEM_SALAC_BERRY,
        .ev = TRAINER_PARTY_EVS(112, 112, 112, 252, 252, 112),
        .nature = NATURE_TIMID
    },
    [SLATEPORT_TENT_MON_HOUNDOUR_2] = {
        .species = SPECIES_HOUNDOUR,
        .moves = {MOVE_LEECH_LIFE, MOVE_DRAGON_CLAW, MOVE_PUNISHMENT, MOVE_WILL_O_WISP},
    ...
    [SLATEPORT_TENT_MON_KOFFING_1] = {
        ...
        .moves = {MOVE_SLUDGE_BOMB, MOVE_SELF_DESTRUCT, MOVE_RAPID_SPIN, MOVE_THIEF},
        .heldItem = ITEM_NONE,
        .ev = TRAINER_PARTY_EVS(252, 96, 252, 96, 96, 96),
    ...
    [SLATEPORT_TENT_MON_KOFFING_2] = {
        .species = SPECIES_KOFFING,
        .moves = {MOVE_CLEAR_SMOG, MOVE_TOXIC_SPIKES, MOVE_FIRE_BLAST, MOVE_THUNDER},
        .heldItem = ITEM_WISE_GLASSES,
        .ev = TRAINER_PARTY_EVS(96, 96, 252, 96, 252, 96),
        .nature = NATURE_BOLD
    },
    [SLATEPORT_TENT_MON_SPINDA_1] = {
        .species = SPECIES_SPINDA,
        .moves = {MOVE_UPROAR, MOVE_PSYSHOCK, MOVE_CALM_MIND, MOVE_BATON_PASS},
        .heldItem = ITEM_STARF_BERRY,
        .ev = TRAINER_PARTY_EVS(64, 64, 64, 252, 252, 64),
        .nature = NATURE_MODEST
    },
    [SLATEPORT_TENT_MON_SPINDA_2] = {
        .species = SPECIES_SPINDA,
        .moves = {MOVE_DIZZY_PUNCH, MOVE_DISTORTION_BOMB, MOVE_SUCKER_PUNCH, MOVE_DIG},
...
const struct TrainerMon gVerdanturfBattleTentMons[NUM_VERDANTURF_TENT_MONS] =
{
    [VERDANTURF_TENT_MON_POOCHYENA] = {
        ...
        .moves = {MOVE_ROAR, MOVE_THROAT_CHOP, MOVE_CRUNCH, MOVE_HOWL},
    ...
    [VERDANTURF_TENT_MON_ZIGZAGOON] = {
        ...
        .moves = {MOVE_COVET, MOVE_GROWL, MOVE_PIN_MISSILE, MOVE_REST},
        .heldItem = ITEM_LUM_BERRY,
        .ev = TRAINER_PARTY_EVS(252, 252, 252, 252, 252, 252),
        .nature = NATURE_ADAMANT
    },
    [VERDANTURF_TENT_MON_DUSTOX] = {
        .species = SPECIES_DUSTOX,
        .moves = {MOVE_CONFUSION, MOVE_MOONLIGHT, MOVE_AIR_CUTTER, MOVE_POISON_POWDER},
        .heldItem = ITEM_CRYSTAL_BALL,
        .ev = TRAINER_PARTY_EVS(170, 0, 170, 170, 170, 170),
        .nature = NATURE_MODEST
    },
    [VERDANTURF_TENT_MON_TAILLOW] = {
        .species = SPECIES_TAILLOW,
        .moves = {MOVE_AERIAL_ACE, MOVE_DOUBLE_TEAM, MOVE_QUICK_ATTACK, MOVE_GROWL},
        .heldItem = ITEM_ORAN_BERRY,
        .ev = TRAINER_PARTY_EVS(200, 200, 200, 200, 200, 0),
        .nature = NATURE_RELAXED
    },
    [VERDANTURF_TENT_MON_SHROOMISH] = {
        .species = SPECIES_SHROOMISH,
        .moves = {MOVE_HEADBUTT, MOVE_STUN_SPORE, MOVE_MEGA_DRAIN, MOVE_GROWTH},
        .heldItem = ITEM_SITRUS_BERRY,
        .ev = TRAINER_PARTY_EVS(252, 128, 128, 252, 128, 128),
        .nature = NATURE_RASH
    },
    [VERDANTURF_TENT_MON_MACHOP] = {
        ...
        .ev = TRAINER_PARTY_EVS(252, 252, 170, 170, 0, 0),
        .nature = NATURE_LONELY
    },
    [VERDANTURF_TENT_MON_MAGIKARP] = {
        .species = SPECIES_MAGIKARP,
        .moves = {MOVE_HYDRO_PUMP, MOVE_FLAIL, MOVE_TACKLE, MOVE_DRACO_METEOR},
        .heldItem = ITEM_SILK_SCARF,
        .ev = TRAINER_PARTY_EVS(252, 252, 252, 252, 252, 252),
        .nature = NATURE_HARDY
    },
    [VERDANTURF_TENT_MON_BARBOACH] = {
        ...
        .moves = {MOVE_MUD_SLAP, MOVE_AQUA_TAIL, MOVE_RAIN_DANCE, MOVE_SPARK},
        .heldItem = ITEM_ASPEAR_BERRY,
        .ev = TRAINER_PARTY_EVS(252, 252, 252, 252, 0, 0),
        .nature = NATURE_HASTY
    },
    [VERDANTURF_TENT_MON_WINGULL] = {
        .species = SPECIES_WINGULL,
        .moves = {MOVE_ATTRACT, MOVE_TWISTER, MOVE_BRINE, MOVE_SUPERSONIC},
        .heldItem = ITEM_SHARP_BEAK,
        .ev = TRAINER_PARTY_EVS(200, 0, 200, 200, 200, 200),
        .nature = NATURE_IMPISH
    },
    [VERDANTURF_TENT_MON_ARON_1] = {
        .species = SPECIES_ARON,
        .moves = {MOVE_ENDEAVOR, MOVE_METAL_CLAW, MOVE_TACKLE, MOVE_ROCK_TOMB},
        .heldItem = ITEM_RAWST_BERRY,
    ...
    [VERDANTURF_TENT_MON_NUMEL_1] = {
        ...
        .moves = {MOVE_EMBER, MOVE_SCORCHING_SANDS, MOVE_FOCUS_ENERGY, MOVE_GROWL},
        .heldItem = ITEM_CHARCOAL,
        .ev = TRAINER_PARTY_EVS(200, 252, 200, 0, 252, 200),
        .nature = NATURE_SASSY
    },
    [VERDANTURF_TENT_MON_GOLBAT] = {
        .species = SPECIES_GOLBAT,
        .moves = {MOVE_NASTY_PLOT, MOVE_POISON_FANG, MOVE_AIR_CUTTER, MOVE_MEAN_LOOK},
        .heldItem = ITEM_POISON_BARB,
        .ev = TRAINER_PARTY_EVS(252, 252, 0, 170, 170, 0),
        .nature = NATURE_BOLD
    },
    [VERDANTURF_TENT_MON_KECLEON] = {
        .species = SPECIES_KECLEON,
        .moves = {MOVE_SUBSTITUTE, MOVE_GRASSY_TERRAIN, MOVE_TERRAIN_PULSE, MOVE_SYNCHRONOISE},
        .heldItem = ITEM_LAX_INCENSE,
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 252, 252),
        .nature = NATURE_QUIET
    },
    [VERDANTURF_TENT_MON_BALTOY] = {
        .species = SPECIES_BALTOY,
        .moves = {MOVE_SANDSTORM, MOVE_FLASH, MOVE_SELF_DESTRUCT, MOVE_TWIN_BEAM},
        .heldItem = ITEM_LEFTOVERS,
        .ev = TRAINER_PARTY_EVS(170, 230, 170, 0, 170, 170),
        .nature = NATURE_NAUGHTY
    },
    [VERDANTURF_TENT_MON_NINJASK] = {
        .species = SPECIES_NINJASK,
        .moves = {MOVE_AERIAL_ACE, MOVE_SCREECH, MOVE_SWORDS_DANCE, MOVE_LEECH_LIFE},
        .heldItem = ITEM_LIECHI_BERRY,
        .ev = TRAINER_PARTY_EVS(152, 152, 152, 152, 152, 152),
        .nature = NATURE_SASSY
    },
    [VERDANTURF_TENT_MON_MAKUHITA] = {
    ...
    [VERDANTURF_TENT_MON_SWABLU] = {
        ...
        .moves = {MOVE_ICY_WIND, MOVE_SAFEGUARD, MOVE_ATTRACT, MOVE_MIRROR_MOVE},
        .heldItem = ITEM_BRIGHT_POWDER,
        .ev = TRAINER_PARTY_EVS(252, 100, 0, 252, 252, 252),
        .nature = NATURE_MILD
    },
    [VERDANTURF_TENT_MON_GOLDEEN_1] = {
    ...
    [VERDANTURF_TENT_MON_LOTAD] = {
        ...
        .moves = {MOVE_GROWL, MOVE_BUBBLE_BEAM, MOVE_GIGA_DRAIN, MOVE_PROTECT},
        .heldItem = ITEM_IAPAPA_BERRY,
        .ev = TRAINER_PARTY_EVS(170, 0, 170, 0, 252, 170),
        .nature = NATURE_QUIRKY
    },
    [VERDANTURF_TENT_MON_NUMEL_2] = {
        .species = SPECIES_NUMEL,
        .moves = {MOVE_BULLDOZE, MOVE_LAVA_PLUME, MOVE_GROWL, MOVE_CURSE},
        .heldItem = ITEM_HARD_STONE,
        .ev = TRAINER_PARTY_EVS(252, 252, 252, 0, 252, 0),
        .nature = NATURE_RELAXED
    },
    [VERDANTURF_TENT_MON_LINOONE] = {
        .species = SPECIES_LINOONE,
        ...
        .heldItem = ITEM_QUICK_CLAW,
        .ev = TRAINER_PARTY_EVS(128, 252, 128, 252, 0, 128),
        .nature = NATURE_IMPISH
    },
    [VERDANTURF_TENT_MON_SEVIPER] = {
        ...
        .heldItem = ITEM_ASPEAR_BERRY,
        .ev = TRAINER_PARTY_EVS(252, 252, 170, 0, 0, 170),
        .nature = NATURE_LONELY
    },
    [VERDANTURF_TENT_MON_SKARMORY] = {
        .species = SPECIES_SKARMORY,
        .moves = {MOVE_STEEL_WING, MOVE_SANDSTORM, MOVE_LEER, MOVE_WING_ATTACK},
        .heldItem = ITEM_JABOCA_BERRY,
        .ev = TRAINER_PARTY_EVS(128, 252, 0, 128, 0, 252),
    ...
    [VERDANTURF_TENT_MON_GOLDEEN_2] = {
        .species = SPECIES_GOLDEEN,
        .moves = {MOVE_SIGNAL_BEAM, MOVE_SURF, MOVE_PSYBEAM, MOVE_RAIN_DANCE},
        .heldItem = ITEM_KINGS_ROCK,
        .ev = TRAINER_PARTY_EVS(200, 0, 200, 252, 252, 200),
        .nature = NATURE_GENTLE
    },
    [VERDANTURF_TENT_MON_ELECTRIKE] = {
        .species = SPECIES_ELECTRIKE,
        .moves = {MOVE_SHOCK_WAVE, MOVE_VOLT_SWITCH, MOVE_CHARGE, MOVE_THUNDER_WAVE},
        .heldItem = ITEM_FOCUS_BAND,
        .ev = TRAINER_PARTY_EVS(200, 0, 170, 170, 252, 170),
        .nature = NATURE_MILD
    },
    [VERDANTURF_TENT_MON_NUZLEAF] = {
        .species = SPECIES_NUZLEAF,
        .moves = {MOVE_SUNNY_DAY, MOVE_TORMENT, MOVE_FAKE_OUT, MOVE_RAZOR_LEAF},
        .heldItem = ITEM_MIRACLE_SEED,
        .ev = TRAINER_PARTY_EVS(200, 200, 128, 200, 200, 128),
        .nature = NATURE_BOLD
    },
    [VERDANTURF_TENT_MON_ARON_2] = {
        .species = SPECIES_ARON,
    ...
    [VERDANTURF_TENT_MON_MIGHTYENA] = {
        .species = SPECIES_MIGHTYENA,
        .moves = {MOVE_HOWL, MOVE_CRUNCH, MOVE_ODOR_SLEUTH, MOVE_SNARL},
        .heldItem = ITEM_KINGS_ROCK,
        .ev = TRAINER_PARTY_EVS(170, 170, 170, 252, 252, 252),
        .nature = NATURE_QUIRKY
    },
    [VERDANTURF_TENT_MON_SOLROCK] = {
        .species = SPECIES_SOLROCK,
        .moves = {MOVE_HARDEN, MOVE_ROCK_SLIDE, MOVE_HYPNOSIS, MOVE_ANGEL_LADDER},
        .heldItem = ITEM_MUSCLE_BAND,
        .ev = TRAINER_PARTY_EVS(0, 252, 170, 0, 0, 252),
        .nature = NATURE_ADAMANT
    },
    [VERDANTURF_TENT_MON_GRAVELER] = {
        .species = SPECIES_GRAVELER,
        ...
        .heldItem = ITEM_FOCUS_BAND,
        .ev = TRAINER_PARTY_EVS(200, 252, 252, 0, 0, 200),
        .nature = NATURE_IMPISH
    },
    [VERDANTURF_TENT_MON_KADABRA] = {
        .species = SPECIES_KADABRA,
        ...
        .heldItem = ITEM_TWISTED_SPOON,
        .ev = TRAINER_PARTY_EVS(170, 0, 170, 200, 230, 170),
        .nature = NATURE_QUIET
    },
    [VERDANTURF_TENT_MON_VOLTORB] = {
        .species = SPECIES_VOLTORB,
    ...
    [VERDANTURF_TENT_MON_MAGNEMITE] = {
        ...
        .heldItem = ITEM_MAGNET,
        .ev = TRAINER_PARTY_EVS(184, 184, 184, 184, 252, 184),
        .nature = NATURE_SERIOUS
    },
    [VERDANTURF_TENT_MON_PELIPPER] = {
        .species = SPECIES_PELIPPER,
        .moves = {MOVE_WING_ATTACK, MOVE_MIST, MOVE_WATER_PULSE, MOVE_PROTECT},
        .heldItem = ITEM_FIGY_BERRY,
        .ev = TRAINER_PARTY_EVS(128, 170, 252, 0, 252, 0),
        .nature = NATURE_BRAVE
    },
    [VERDANTURF_TENT_MON_LOUDRED] = {
        .species = SPECIES_LOUDRED,
        .moves = {MOVE_UPROAR, MOVE_DANCING_RAIN, MOVE_REST, MOVE_ROAR},
        .heldItem = ITEM_LEFTOVERS,
        .ev = TRAINER_PARTY_EVS(170, 252, 170, 0, 252, 170),
        .nature = NATURE_CALM
    },
    [VERDANTURF_TENT_MON_MARILL] = {
        .species = SPECIES_MARILL,
        .moves = {MOVE_ROLLOUT, MOVE_DEFENSE_CURL, MOVE_TAIL_WHIP, MOVE_AQUA_TAIL},
        .heldItem = ITEM_RAWST_BERRY,
        .ev = TRAINER_PARTY_EVS(252, 252, 170, 170, 0, 170),
        .nature = NATURE_JOLLY
    },
    [VERDANTURF_TENT_MON_TRAPINCH] = {
        .species = SPECIES_TRAPINCH,
        .moves = {MOVE_DIG, MOVE_BUG_BITE, MOVE_SANDSTORM, MOVE_CRUNCH},
        .heldItem = ITEM_MIRROR_HERB,
        .ev = TRAINER_PARTY_EVS(200, 170, 170, 170, 0, 170),
        .nature = NATURE_NAUGHTY
    },
    [VERDANTURF_TENT_MON_TENTACOOL] = {
        .species = SPECIES_TENTACOOL,
        ...
        .heldItem = ITEM_BRIGHT_POWDER,
        .ev = TRAINER_PARTY_EVS(252, 252, 0, 252, 0, 252),
        .nature = NATURE_RELAXED
    },
    [VERDANTURF_TENT_MON_VIGOROTH] = {
        ...
        .heldItem = ITEM_MENTAL_HERB,
        .ev = TRAINER_PARTY_EVS(0, 252, 170, 0, 200, 170),
        .nature = NATURE_QUIRKY
    },
    [VERDANTURF_TENT_MON_WAILMER] = {
        ...
        .heldItem = ITEM_WHITE_HERB,
        .ev = TRAINER_PARTY_EVS(252, 170, 170, 170, 170, 170),
        .nature = NATURE_RELAXED
    },
    [VERDANTURF_TENT_MON_ILLUMISE] = {
        .species = SPECIES_ILLUMISE,
        .moves = {MOVE_SCATTER_BEAM, MOVE_STRUGGLE_BUG, MOVE_WISH, MOVE_ENCORE},
        .heldItem = ITEM_BRIGHT_POWDER,
        .ev = TRAINER_PARTY_EVS(170, 0, 170, 0, 252, 170),
        .nature = NATURE_QUIRKY
    },
    ...
    [VERDANTURF_TENT_MON_WHISMUR] = {
        ...
        .moves = {MOVE_HYPER_VOICE, MOVE_SUPERSONIC, MOVE_STOMP, MOVE_ROAR},
        .heldItem = ITEM_LIFE_ORB,
        .ev = TRAINER_PARTY_EVS(252, 252, 252, 252, 252, 252),
        .nature = NATURE_QUIRKY
    },
    [VERDANTURF_TENT_MON_CACNEA] = {
        ...
        .heldItem = ITEM_SCOPE_LENS,
        .ev = TRAINER_PARTY_EVS(230, 230, 230, 230, 230, 230),
        .nature = NATURE_SERIOUS
    }
};
...
const struct TrainerMon gFallarborBattleTentMons[NUM_FALLARBOR_TENT_MONS] =
{
    [FALLARBOR_TENT_MON_NUMEL] = {
        ...
        .heldItem = ITEM_CHARCOAL,
        .ev = TRAINER_PARTY_EVS(252, 170, 170, 0, 252, 170),
        .nature = NATURE_QUIET
    },
    [FALLARBOR_TENT_MON_LINOONE_1] = {
        .species = SPECIES_LINOONE,
        .moves = {MOVE_TAKE_DOWN, MOVE_COVET, MOVE_ROCK_SMASH, MOVE_CHARM},
        .heldItem = ITEM_SILK_SCARF,
    ...
    [FALLARBOR_TENT_MON_PLUSLE] = {
        ...
        .heldItem = ITEM_MENTAL_HERB,
        .ev = TRAINER_PARTY_EVS(128, 252, 0, 252, 252, 0),
        .nature = NATURE_MODEST
    },
    [FALLARBOR_TENT_MON_POOCHYENA] = {
        .species = SPECIES_POOCHYENA,
        .moves = {MOVE_YAWN, MOVE_ICE_FANG, MOVE_HOWL, MOVE_FRUSTRATION},
    ...
    [FALLARBOR_TENT_MON_KECLEON] = {
        .species = SPECIES_KECLEON,
        .moves = {MOVE_SHADOW_CLAW, MOVE_SLASH, MOVE_FEINT_ATTACK, MOVE_SUCKER_PUNCH},
        .heldItem = ITEM_WIKI_BERRY,
        .ev = TRAINER_PARTY_EVS(170, 170, 170, 170, 170, 170),
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_MAGIKARP] = {
        .species = SPECIES_MAGIKARP,
        .moves = {MOVE_HYDRO_PUMP, MOVE_TACKLE, MOVE_FLAIL, MOVE_DRACO_METEOR},
        .heldItem = ITEM_WHITE_HERB,
        .ev = TRAINER_PARTY_EVS(252, 252, 252, 252, 252, 252),
        .nature = NATURE_QUIRKY
    },
    [FALLARBOR_TENT_MON_SOLROCK] = {
        .species = SPECIES_SOLROCK,
        .moves = {MOVE_ROCK_THROW, MOVE_FLASH, MOVE_SANDSTORM, MOVE_LIGHT_UP},
        .heldItem = ITEM_HARD_STONE,
        .ev = TRAINER_PARTY_EVS(170, 200, 170, 0, 0, 170),
        .nature = NATURE_SASSY
    },
    [FALLARBOR_TENT_MON_MAKUHITA] = {
        .species = SPECIES_MAKUHITA,
        ...
        .heldItem = ITEM_BLACK_BELT,
        .ev = TRAINER_PARTY_EVS(252, 252, 128, 0, 252, 0),
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_MACHOKE] = {
        .species = SPECIES_MACHOKE,
        .moves = {MOVE_COUNTER, MOVE_REVENGE, MOVE_BULK_UP, MOVE_DOUBLE_HIT},
        .heldItem = ITEM_SCOPE_LENS,
        .ev = TRAINER_PARTY_EVS(170, 230, 0, 170, 170, 0),
        .nature = NATURE_NAIVE
    },
    [FALLARBOR_TENT_MON_NINCADA] = {
        .species = SPECIES_NINCADA,
        .moves = {MOVE_FURY_SWIPES, MOVE_ENDURE, MOVE_TRAILBLAZE, MOVE_DIG},
        .heldItem = ITEM_LUM_BERRY,
        .ev = TRAINER_PARTY_EVS(252, 252, 0, 252, 0, 0),
        .nature = NATURE_SERIOUS
    },
    [FALLARBOR_TENT_MON_BEAUTIFLY] = {
        ...
        .heldItem = ITEM_BRIGHT_POWDER,
        .ev = TRAINER_PARTY_EVS(252, 128, 128, 128, 252, 128),
        .nature = NATURE_QUIRKY
    },
    [FALLARBOR_TENT_MON_DUSTOX] = {
        .species = SPECIES_DUSTOX,
        .moves = {MOVE_MOONLIGHT, MOVE_HARDEN, MOVE_VENOSHOCK, MOVE_PSYBEAM},
        .heldItem = ITEM_FOCUS_BAND,
        .ev = TRAINER_PARTY_EVS(252, 0, 170, 170, 252, 170),
        .nature = NATURE_DOCILE
    },
    [FALLARBOR_TENT_MON_ILLUMISE] = {
        .species = SPECIES_ILLUMISE,
        .moves = {MOVE_METRONOME, MOVE_FLATTER, MOVE_WISH, MOVE_STRUGGLE_BUG},
        .heldItem = ITEM_SALAC_BERRY,
        .ev = TRAINER_PARTY_EVS(252, 252, 252, 0, 252, 0),
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_VOLBEAT] = {
        ...
        .moves = {MOVE_LIGHT_UP, MOVE_MOONLIGHT, MOVE_SIGNAL_BEAM, MOVE_TAIL_GLOW},
        .heldItem = ITEM_LEPPA_BERRY,
        .ev = TRAINER_PARTY_EVS(252, 170, 0, 170, 170, 170),
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_NINJASK_1] = {
        .species = SPECIES_NINJASK,
        ...
        .heldItem = ITEM_LIECHI_BERRY,
        .ev = TRAINER_PARTY_EVS(128, 0, 252, 128, 0, 252),
        .nature = NATURE_JOLLY
    },
    [FALLARBOR_TENT_MON_NINJASK_2] = {
        .species = SPECIES_NINJASK,
        .moves = {MOVE_SWORDS_DANCE, MOVE_CUT, MOVE_BUG_BITE, MOVE_LEECH_LIFE},
    ...
    [FALLARBOR_TENT_MON_ARON_1] = {
        ...
        .heldItem = ITEM_SCOPE_LENS,
        .ev = TRAINER_PARTY_EVS(252, 252, 252, 0, 252, 128),
        .nature = NATURE_LONELY
    },
    [FALLARBOR_TENT_MON_ARON_2] = {
        .species = SPECIES_ARON,
        ...
        .heldItem = ITEM_SITRUS_BERRY,
        .ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 252, 252),
        .nature = NATURE_GENTLE
    },
    [FALLARBOR_TENT_MON_ELECTRIKE] = {
        .species = SPECIES_ELECTRIKE,
        .moves = {MOVE_CRUNCH, MOVE_THUNDER_WAVE, MOVE_HOWL, MOVE_LIGHTNING_CUT},
        .heldItem = ITEM_SILK_SCARF,
        .ev = TRAINER_PARTY_EVS(170, 170, 252, 252, 0, 0),
        .nature = NATURE_HASTY
    },
    [FALLARBOR_TENT_MON_MAGNEMITE] = {
        .species = SPECIES_MAGNEMITE,
        .moves = {MOVE_THUNDER_WAVE, MOVE_SUPERSONIC, MOVE_ENDURE, MOVE_ELECTRO_BALL},
        .heldItem = ITEM_MAGNET,
        .ev = TRAINER_PARTY_EVS(252, 0, 0, 252, 252, 252),
        .nature = NATURE_QUIET
    },
    [FALLARBOR_TENT_MON_VOLTORB] = {
        .species = SPECIES_VOLTORB,
        .moves = {MOVE_CHARGE, MOVE_SPARK, MOVE_SCREECH, MOVE_EERIE_IMPULSE},
        .heldItem = ITEM_ASPEAR_BERRY,
        .ev = TRAINER_PARTY_EVS(128, 252, 128, 252, 0, 128),
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_WHISMUR] = {
        .species = SPECIES_WHISMUR,
        .moves = {MOVE_REST, MOVE_SLEEP_TALK, MOVE_HYPER_VOICE, MOVE_SHOCK_WAVE},
        .heldItem = ITEM_LAX_INCENSE,
        .ev = TRAINER_PARTY_EVS(170, 0, 170, 170, 252, 170),
        .nature = NATURE_MODEST
    },
    [FALLARBOR_TENT_MON_LOUDRED] = {
        .species = SPECIES_LOUDRED,
        .moves = {MOVE_STOMP, MOVE_DANCING_RAIN, MOVE_SCREECH, MOVE_REST},
        .heldItem = ITEM_CHESTO_BERRY,
        .ev = TRAINER_PARTY_EVS(252, 252, 0, 252, 0, 0),
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_LINOONE_2] = {
        .species = SPECIES_LINOONE,
        .moves = {MOVE_FURY_SWIPES, MOVE_SAND_ATTACK, MOVE_PIN_MISSILE, MOVE_GROWL},
        .heldItem = ITEM_LOADED_DICE,
        .ev = TRAINER_PARTY_EVS(252, 252, 128, 0, 0, 0),
        .nature = NATURE_HARDY
    },
    [FALLARBOR_TENT_MON_MIGHTYENA] = {
        .species = SPECIES_MIGHTYENA,
        .moves = {MOVE_ASSURANCE, MOVE_HOWL, MOVE_SWAGGER, MOVE_SECRET_POWER},
        .heldItem = ITEM_KINGS_ROCK,
        .ev = TRAINER_PARTY_EVS(170, 170, 0, 252, 0, 170),
        .nature = NATURE_JOLLY
    },
    [FALLARBOR_TENT_MON_SWABLU] = {
        .species = SPECIES_SWABLU,
        .moves = {MOVE_DUAL_WINGBEAT, MOVE_SING, MOVE_COTTON_GUARD, MOVE_SAFEGUARD},
        .heldItem = ITEM_FOCUS_BAND,
        .ev = TRAINER_PARTY_EVS(252, 252, 200, 0, 0, 200),
        .nature = NATURE_QUIRKY
    },
    [FALLARBOR_TENT_MON_SKARMORY] = {
        .species = SPECIES_SKARMORY,
        .moves = {MOVE_AGILITY, MOVE_STEEL_WING, MOVE_WING_ATTACK, MOVE_TORMENT},
        .heldItem = ITEM_METAL_COAT,
        .ev = TRAINER_PARTY_EVS(170, 170, 170, 170, 0, 170),
        .nature = NATURE_BOLD
    },
    [FALLARBOR_TENT_MON_GOLBAT_1] = {
        .species = SPECIES_GOLBAT,
        .moves = {MOVE_CONFUSE_RAY, MOVE_BITE, MOVE_POISON_FANG, MOVE_SUBSTITUTE},
        .heldItem = ITEM_BABIRI_BERRY,
        .ev = TRAINER_PARTY_EVS(170, 170, 170, 252, 0, 0),
        .nature = NATURE_BOLD
    },
    [FALLARBOR_TENT_MON_WINGULL] = {
        .species = SPECIES_WINGULL,
        .moves = {MOVE_WING_ATTACK, MOVE_RAIN_DANCE, MOVE_WATER_PULSE, MOVE_SUPERSONIC},
        .heldItem = ITEM_RAWST_BERRY,
        .ev = TRAINER_PARTY_EVS(0, 0, 252, 252, 252, 252),
        .nature = NATURE_MODEST
    },
    [FALLARBOR_TENT_MON_PELIPPER] = {
        .species = SPECIES_PELIPPER,
        .moves = {MOVE_TWISTER, MOVE_MIST, MOVE_DOUBLE_TEAM, MOVE_WATER_GUN},
        .heldItem = ITEM_SHARP_BEAK,
        .ev = TRAINER_PARTY_EVS(128, 0, 252, 252, 0, 0),
        .nature = NATURE_HARDY
    },
    [FALLARBOR_TENT_MON_BARBOACH] = {
        .species = SPECIES_BARBOACH,
        .moves = {MOVE_SPARK, MOVE_AQUA_TAIL, MOVE_EARTHQUAKE, MOVE_WATER_SPORT},
        .heldItem = ITEM_LIECHI_BERRY,
        .ev = TRAINER_PARTY_EVS(252, 252, 100, 0, 0, 100),
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_WAILMER] = {
        .species = SPECIES_WAILMER,
        .moves = {MOVE_WATER_SPOUT, MOVE_RAIN_DANCE, MOVE_ROLLOUT, MOVE_CURSE},
        .heldItem = ITEM_HEAVY_DUTY_BOOTS,
    ...
    [FALLARBOR_TENT_MON_MARILL] = {
        .species = SPECIES_MARILL,
        .moves = {MOVE_DEFENSE_CURL, MOVE_ROLLOUT, MOVE_AQUA_TAIL, MOVE_ATTRACT},
        .heldItem = ITEM_HARD_STONE,
        .ev = TRAINER_PARTY_EVS(252, 252, 128, 128, 0, 128),
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_GOLDEEN_1] = {
        .species = SPECIES_GOLDEEN,
        ...
        .ev = TRAINER_PARTY_EVS(200, 252, 200, 252, 0, 0),
        .nature = NATURE_HASTY
    },
    [FALLARBOR_TENT_MON_GOLDEEN_2] = {
        .species = SPECIES_GOLDEEN,
        ...
        .heldItem = ITEM_MENTAL_HERB,
        .ev = TRAINER_PARTY_EVS(252, 0, 252, 100, 0, 252),
        .nature = NATURE_CAREFUL
    },
    [FALLARBOR_TENT_MON_TRAPINCH] = {
        .species = SPECIES_TRAPINCH,
        .moves = {MOVE_RETURN, MOVE_SAND_ATTACK, MOVE_BULLDOZE, MOVE_STRENGTH},
        .heldItem = ITEM_MAGO_BERRY,
        .ev = TRAINER_PARTY_EVS(200, 252, 0, 252, 0, 0),
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_BALTOY] = {
        .species = SPECIES_BALTOY,
        ...
        .heldItem = ITEM_SCOPE_LENS,
        .ev = TRAINER_PARTY_EVS(170, 252, 170, 170, 170, 170),
        .nature = NATURE_JOLLY
    },
    [FALLARBOR_TENT_MON_GRAVELER] = {
        .species = SPECIES_GRAVELER,
        .moves = {MOVE_STONE_EDGE, MOVE_DEFENSE_CURL, MOVE_SUCKER_PUNCH, MOVE_MUD_SPORT},
        .heldItem = ITEM_CRYSTAL_BALL,
        .ev = TRAINER_PARTY_EVS(252, 170, 170, 0, 0, 252),
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_SANDSHREW] = {
        .species = SPECIES_SANDSHREW,
        .moves = {MOVE_SAND_TOMB, MOVE_SANDSTORM, MOVE_DOUBLE_TEAM, MOVE_CRUSH_CLAW},
    ...
    [FALLARBOR_TENT_MON_GOLBAT_2] = {
        .species = SPECIES_GOLBAT,
        .moves = {MOVE_TOXIC, MOVE_VENOSHOCK, MOVE_AIR_CUTTER, MOVE_GIGA_DRAIN},
        .heldItem = ITEM_SCOPE_LENS,
        .ev = TRAINER_PARTY_EVS(252, 0, 100, 0, 252, 252),
        .nature = NATURE_QUIRKY
    },
    [FALLARBOR_TENT_MON_SHROOMISH] = {
        .species = SPECIES_SHROOMISH,
        ...
        .heldItem = ITEM_QUICK_CLAW,
        .ev = TRAINER_PARTY_EVS(170, 170, 252, 170, 0, 252),
        .nature = NATURE_IMPISH
    },
    [FALLARBOR_TENT_MON_GLOOM] = {
        .species = SPECIES_GLOOM,
        .moves = {MOVE_SLEEP_POWDER, MOVE_GROWTH, MOVE_ACID, MOVE_MEGA_DRAIN},
        .heldItem = ITEM_SITRUS_BERRY,
    ...
    [FALLARBOR_TENT_MON_LOMBRE] = {
        .species = SPECIES_LOMBRE,
        .moves = {MOVE_ENERGY_BALL, MOVE_WATER_GUN, MOVE_RAIN_DANCE, MOVE_FLASH},
        .heldItem = ITEM_LEFTOVERS,
        .ev = TRAINER_PARTY_EVS(170, 0, 170, 0, 230, 170),
        .nature = NATURE_BASHFUL
    },
    [FALLARBOR_TENT_MON_NUZLEAF] = {
        .species = SPECIES_NUZLEAF,
        .moves = {MOVE_RAZOR_LEAF, MOVE_TORMENT, MOVE_SWAGGER, MOVE_REST},
        .heldItem = ITEM_CHESTO_BERRY,
        .ev = TRAINER_PARTY_EVS(252, 252, 100, 252, 0, 100),
        .nature = NATURE_ADAMANT
    },
    [FALLARBOR_TENT_MON_CACNEA] = {
        .species = SPECIES_CACNEA,
        ...
        .heldItem = ITEM_BRIGHT_POWDER,
        .ev = TRAINER_PARTY_EVS(252, 0, 252, 252, 0, 252),
        .nature = NATURE_ADAMANT
    }
};
