...
{
    {COMPOUND_STRING("Blunder Policy{CLEAR_TO 0x51}500 COINS")},
    {COMPOUND_STRING("Wide Lens{CLEAR_TO 0x48}1,000 COINS")},
    {COMPOUND_STRING("Zoom Lens{CLEAR_TO 0x48}1,000 COINS")},
    {COMPOUND_STRING("Metronome{CLEAR_TO 0x48}1,500 COINS")},
    {COMPOUND_STRING("Loaded Dice{CLEAR_TO 0x48}2,000 COINS")},
    {gText_Exit},
};
...
static const struct MenuAction MultichoiceList_Fossil2[] =
{
...
static const struct MultichoiceListStruct sMultichoiceLists[] =
{
    ...
    [MULTI_FOSSIL_2]                   = MULTICHOICE(MultichoiceList_Fossil2),
