...
static const struct FlashStruct sTransitionTypes[] =
{
    ...
    {MAP_TYPE_ROUTE,       MAP_TYPE_DREAM,        TRUE, FALSE, DoEnterCaveTransition},
    ...
    {MAP_TYPE_UNDERGROUND, MAP_TYPE_DREAM  ,     FALSE,  TRUE, DoExitCaveTransition},
    ...
    {MAP_TYPE_DREAM,       MAP_TYPE_INDOOR,      FALSE,  TRUE, DoExitCaveTransition},
    {MAP_TYPE_DREAM,       MAP_TYPE_ROUTE,       FALSE,  TRUE, DoExitCaveTransition},
    {},
};
